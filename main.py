from SphereGAN import SphereGAN
import argparse
from utils import *

"""parsing and configuration"""
def parse_args():
    desc = "Tensorflow implementation of SphereGAN"
    parser = argparse.ArgumentParser(description=desc)
    parser.add_argument('--phase', type=str, default='train', help='train or test ?')
    parser.add_argument('--dataset', type=str, default='celebA', help='[mnist / cifar10 / custom_dataset]')
    ...
    parser.add_argument('--moment', type=int, default=3, help='Moment distance')
    parser.add_argument('--sn', type=str2bool, default=False, help='using spectral norm')

    parser.add_argument('--gan_type', type=str, default='sphere', help='[gan / lsgan / wgan-gp / wgan-lp / dragan / hinge / sphere]')
